...
class AppColors {
  ...
  static final bgAddTaskFieldDark = Color(0xff282851);
  static final textDark = Color(0xffCACADE);
  static final textLabelDark = Color(0xff8B8BB1);
  static final dayDateDark = Color(0xff8EADD8);
